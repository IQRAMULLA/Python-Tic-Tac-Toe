...
b1 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b1))
b1.place(x=130, y=200)

b2 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b2))
b2.place(x=265, y=200)

b3 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b3))
b3.place(x=400, y=200)

b4 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b4))
b4.place(x=130, y=317)

b5 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b5))
b5.place(x=265, y=317)

b6 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b6))
b6.place(x=400, y=317)

b7 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b7))
b7.place(x=130, y=434)

b8 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
            command=lambda: btnclick(b8))
b8.place(x=265, y=434)

b9 = Button(play, text='', font=('calibri', 25, 'bold'), width=7, height=2, bg='brown', fg='white',
